...
| Style       | Description                                                                                                                                         |
| ----------- | --------------------------------------------------------------------------------------------------------------------------------------------------- |
| `default`   | Standard npmx.dev style (20px tall).                                                                                                                |
| `shieldsio` | Classic shields.io-compatible style (20px tall) to match existing badges.                                                                           |
| `compact`   | Same as `default` but 20–50% narrower. Uses tight 5px padding, removes minimum width, and shortens built-in labels (e.g., `dependencies` → `deps`). |

::tip
If you pass an explicit `label` or `name=true`, labels will not be shortened in `compact` mode.
::
